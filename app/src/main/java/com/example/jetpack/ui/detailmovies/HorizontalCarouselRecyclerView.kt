...
class HorizontalCarouselRecyclerView(context: Context, attrs: AttributeSet): RecyclerView(context, attrs) {
    ...
    private val activeColor by lazy { ContextCompat.getColor(context, R.color.blue_100) }
    private val inactiveColor by lazy { ContextCompat.getColor(context, R.color.grey_200) }
